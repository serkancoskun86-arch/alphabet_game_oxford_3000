...
const a1Words = [ 
    ...
    { l: 'B', q: 'A professional who bakes bread.', a: ['baker'], lv: 'A1' },
    ...
    { l: 'D', q: 'The first meal of the day (meal time).', a: ['dinner'], lv: 'A1' },
    { l: 'D', q: 'A person who creates art by hand.', a: ['draw'], lv: 'A1' },
    ...
    // F Harfi
    { l: 'F', q: 'A group of people related by blood.', a: ['family'], lv: 'A1' },
    ...
    { l: 'F', q: 'A animal that lives in water.', a: ['fish'], lv: 'A1' },
    { l: 'F', q: 'The number after three.', a: ['four'], lv: 'A1' },
    { l: 'F', q: 'A color like a rose.', a: ['flower'], lv: 'A1' },
    { l: 'F', q: 'To be happy (feeling).', a: ['fine'], lv: 'A1' },

    // G Harfi
    { l: 'G', q: 'A color like the grass.', a: ['green'], lv: 'A1' },
    { l: 'G', q: 'Area for growing plants.', a: ['garden'], lv: 'A1' },
    { l: 'G', q: 'A child who is female.', a: ['girl'], lv: 'A1' },
    { l: 'G', q: 'To move from one place to another.', a: ['go'], lv: 'A1' },
    { l: 'G', q: 'The opposite of bad.', a: ['good'], lv: 'A1' },
    { l: 'G', q: 'A drink holder made of glass.', a: ['glass'], lv: 'A1' },
    { l: 'G', q: 'To provide something to someone.', a: ['give'], lv: 'A1' },
    { l: 'G', q: 'A type of stringed instrument.', a: ['guitar'], lv: 'A1' },
    ...
    { l: 'H', q: 'A part of the body at the end of the arm.', a: ['hand'], lv: 'A1' },
    { l: 'H', q: 'Something you wear on your head.', a: ['hat'], lv: 'A1' },
    { l: 'H', q: 'The part of the body for thinking.', a: ['head'], lv: 'A1' },
    { l: 'H', q: 'Opposite of sad.', a: ['happy'], lv: 'A1' },
    { l: 'H', q: 'To have something in your hand.', a: ['hold'], lv: 'A1' },

    // I Harfi
    { l: 'I', q: 'Frozen water.', a: ['ice'], lv: 'I1' },
    { l: 'I', q: 'Cold sweet dessert.', a: ['ice cream'], lv: 'A1' },
    { l: 'I', q: 'Something not possible.', a: ['impossible'], lv: 'A1' },
    { l: 'I', q: 'Inside a place.', a: ['in'], lv: 'A1' },
    { l: 'I', q: 'A country like Rome.', a: ['italy'], lv: 'A1' },
    { l: 'I', q: 'To be sick.', a: ['ill'], lv: 'A1' },
    { l: 'I', q: 'Information technology (short).', a: ['it'], lv: 'A1' },
    { l: 'I', q: 'A great or smart thought.', a: ['idea'], lv: 'A1' },

    // J Harfi
    { l: 'J', q: 'Something you do for money.', a: ['job'], lv: 'A1' },
    { l: 'J', q: 'A fruit drink.', a: ['juice'], lv: 'A1' },
    { l: 'J', q: 'The month after May.', a: ['june'], lv: 'A1' },
    { l: 'J', q: 'The month after June.', a: ['july'], lv: 'A1' },
    { l: 'J', q: 'To spring into the air.', a: ['jump'], lv: 'A1' },
    { l: 'J', q: 'A piece of clothing for the upper body.', a: ['jacket'], lv: 'A1' },
    { l: 'J', q: 'The month that starts the year.', a: ['january'], lv: 'A1' },
    { l: 'J', q: 'A sweet food made from fruit.', a: ['jam'], lv: 'A1' },

    // K Harfi
    { l: 'K', q: 'The room where food is cooked.', a: ['kitchen'], lv: 'A1' },
    { l: 'K', q: 'To strike with the foot.', a: ['kick'], lv: 'A1' },
    { l: 'K', q: 'A person who rules a country.', a: ['king'], lv: 'A1' },
    { l: 'K', q: 'A tool to open a door.', a: ['key'], lv: 'A1' },
    { l: 'K', q: 'To touch with lips.', a: ['kiss'], lv: 'A1' },
    { l: 'K', q: 'The part of the body where the leg bends.', a: ['knee'], lv: 'A1' },
    { l: 'K', q: 'To have information.', a: ['know'], lv: 'A1' },
    { l: 'K', q: 'A toy that flies in the wind.', a: ['kite'], lv: 'A1' },

    // L Harfi
    { l: 'L', q: 'To pay attention to sound.', a: ['listen'], lv: 'A1' },
    { l: 'L', q: 'A place where books are kept.', a: ['library'], lv: 'A1' },
    { l: 'L', q: 'The opposite of short.', a: ['long'], lv: 'A1' },
    { l: 'L', q: 'To have a strong feeling of affection.', a: ['love'], lv: 'A1' },
    { l: 'L', q: 'Opposite of small.', a: ['large'], lv: 'A1' },
    { l: 'L', q: 'To gain knowledge.', a: ['learn'], lv: 'A1' },
    { l: 'L', q: 'A part of the body for walking.', a: ['leg'], lv: 'A1' },
    { l: 'L', q: 'Something you use to see in the dark.', a: ['light'], lv: 'A1' },

    // M Harfi
    { l: 'M', q: 'The person who gives birth to you.', a: ['mother', 'mom'], lv: 'A1' },
    { l: 'M', q: 'Something you use to pay for things.', a: ['money'], lv: 'A1' },
    { l: 'M', q: 'The time of day when the sun rises.', a: ['morning'], lv: 'A1' },
    { l: 'M', q: 'A person (adult male).', a: ['man'], lv: 'A1' },
    { l: 'M', q: 'Food from animals.', a: ['meat'], lv: 'A1' },
    { l: 'M', q: 'White liquid from cows.', a: ['milk'], lv: 'A1' },
    { l: 'M', q: 'The object that shines at night.', a: ['moon'], lv: 'A1' },
    { l: 'M', q: 'A story shown in a cinema.', a: ['movie'], lv: 'A1' },

    // N Harfi
    { l: 'N', q: 'The opposite of old.', a: ['new'], lv: 'A1' },
    { l: 'N', q: 'The opposite of day.', a: ['night'], lv: 'A1' },
    { l: 'N', q: 'The number after eight.', a: ['nine'], lv: 'A1' },
    { l: 'N', q: 'The month after October.', a: ['november'], lv: 'A1' },
    { l: 'N', q: 'The part of the body for smelling.', a: ['nose'], lv: 'A1' },
    { l: 'N', q: 'The opposite of yes.', a: ['no'], lv: 'A1' },
    { l: 'N', q: 'Something that is not anything.', a: ['nothing'], lv: 'A1' },
    { l: 'N', q: 'A word for a person, place or thing.', a: ['name'], lv: 'A1' },

    // O Harfi
    { l: 'O', q: 'A fruit and a color.', a: ['orange'], lv: 'A1' },
    { l: 'O', q: 'A huge body of salt water.', a: ['ocean'], lv: 'A1' },
    { l: 'O', q: 'The month after September.', a: ['october'], lv: 'A1' },
    { l: 'O', q: 'The opposite of new.', a: ['old'], lv: 'A1' },
    { l: 'O', q: 'The opposite of closed.', a: ['open'], lv: 'A1' },
    { l: 'O', q: 'The number after zero.', a: ['one'], lv: 'A1' },
    { l: 'O', q: 'Not at home.', a: ['out'], lv: 'A1' },
    { l: 'O', q: 'In a position above.', a: ['over'], lv: 'A1' },

    // P Harfi
    { l: 'P', q: 'A public garden.', a: ['park'], lv: 'A1' },
    { l: 'P', q: 'A device for long distance calls.', a: ['phone'], lv: 'A1' },
    { l: 'P', q: 'A tool used for writing.', a: ['pen'], lv: 'A1' },
    { l: 'P', q: 'A person (singular).', a: ['person'], lv: 'A1' },
    { l: 'P', q: 'To engage in a game.', a: ['play'], lv: 'A1' },
    { l: 'P', q: 'A drawing or photo.', a: ['picture'], lv: 'A1' },
    { l: 'P', q: 'A color like a light red.', a: ['pink'], lv: 'A1' },
    { l: 'P', q: 'A flat dish for food.', a: ['plate'], lv: 'A1' },

    // Q Harfi
    { l: 'Q', q: 'A woman who rules a kingdom.', a: ['queen'], lv: 'A1' },
    { l: 'Q', q: 'Something you ask.', a: ['question'], lv: 'A1' },
    { l: 'Q', q: 'The opposite of slow (adverb).', a: ['quickly'], lv: 'A1' },
    { l: 'Q', q: 'Not loud; silent.', a: ['quiet'], lv: 'A1' },
    { l: 'Q', q: 'To stop doing something.', a: ['quit'], lv: 'A1' },
    { l: 'Q', q: 'A line of people waiting.', a: ['queue'], lv: 'A1' },
    { l: 'Q', q: 'Completely or very.', a: ['quite'], lv: 'A1' },
    { l: 'Q', q: 'A short test.', a: ['quiz'], lv: 'A1' },

    // R Harfi
    { l: 'R', q: 'Water falling from the sky.', a: ['rain'], lv: 'A1' },
    { l: 'R', q: 'A color like a tomato.', a: ['red'], lv: 'A1' },
    { l: 'R', q: 'To look at words in a book.', a: ['read'], lv: 'A1' },
    { l: 'R', q: 'To move fast on legs.', a: ['run'], lv: 'A1' },
    { l: 'R', q: 'A place to stay for the night.', a: ['room'], lv: 'A1' },
    { l: 'R', q: 'A place where you buy and eat food.', a: ['restaurant'], lv: 'A1' },
    { l: 'R', q: 'A flow of water to the sea.', a: ['river'], lv: 'A1' },
    { l: 'R', q: 'The opposite of left.', a: ['right'], lv: 'A1' },

    // S Harfi
    { l: 'S', q: 'A star that gives light to Earth.', a: ['sun'], lv: 'A1' },
    { l: 'S', q: 'A building where children learn.', a: ['school'], lv: 'A1' },
    { l: 'S', q: 'To talk with a melody.', a: ['sing'], lv: 'A1' },
    { l: 'S', q: 'The opposite of tall.', a: ['short'], lv: 'A1' },
    { l: 'S', q: 'The opposite of big.', a: ['small'], lv: 'A1' },
    { l: 'S', q: 'A place for buying things.', a: ['shop'], lv: 'A1' },
    { l: 'S', q: 'To rest with eyes closed.', a: ['sleep'], lv: 'A1' },
    { l: 'S', q: 'A season of the year (hot).', a: ['summer'], lv: 'A1' },
    ...
    { l: 'T', q: 'A hot drink from leaves.', a: ['tea'], lv: 'A1' },
    { l: 'T', q: 'To speak to someone.', a: ['talk'], lv: 'A1' },
    { l: 'T', q: 'A vehicle on tracks.', a: ['train'], lv: 'A1' },
    { l: 'T', q: 'A large plant with a trunk.', a: ['tree'], lv: 'A1' },
    { l: 'T', q: 'The day of the week after Monday.', a: ['tuesday'], lv: 'A1' },

    // U Harfi
    { l: 'U', q: 'Used for rain protection.', a: ['umbrella'], lv: 'A1' },
    { l: 'U', q: 'The opposite of down.', a: ['up'], lv: 'A1' },
    { l: 'U', q: 'To employ something.', a: ['use'], lv: 'A1' },
    { l: 'U', q: 'Below something.', a: ['under'], lv: 'A1' },
    { l: 'U', q: 'The opposite of happy.', a: ['unhappy'], lv: 'A1' },
    { l: 'U', q: 'The brother of your mother/father.', a: ['uncle'], lv: 'A1' },
    { l: 'U', q: 'To comprehend.', a: ['understand'], lv: 'A1' },
    { l: 'U', q: 'A clothes set for school or work.', a: ['uniform'], lv: 'A1' },

    // V Harfi
    { l: 'V', q: 'A small town in the country.', a: ['village'], lv: 'A1' },
    { l: 'V', q: 'Food like carrots or peas.', a: ['vegetable'], lv: 'A1' },
    { l: 'V', q: 'To go and see a place.', a: ['visit'], lv: 'A1' },
    { l: 'V', q: 'A large musical instrument.', a: ['violin'], lv: 'A1' },
    { l: 'V', q: 'The sound you make when talking.', a: ['voice'], lv: 'A1' },
    { l: 'V', q: 'A machine for traveling.', a: ['vehicle'], lv: 'A1' },
    { l: 'V', q: 'A holiday or break.', a: ['vacation'], lv: 'A1' },
    { l: 'V', q: 'A place with lava.', a: ['volcano'], lv: 'A1' },

    // W Harfi
    { l: 'W', q: 'Liquid essential for life.', a: ['water'], lv: 'A1' },
    { l: 'W', q: 'The opposite of cold.', a: ['warm'], lv: 'A1' },
    { l: 'W', q: 'To move on legs slowly.', a: ['walk'], lv: 'A1' },
    { l: 'W', q: 'Something you wear on your wrist.', a: ['watch'], lv: 'A1' },
    { l: 'W', q: 'The season after autumn.', a: ['winter'], lv: 'A1' },
    { l: 'W', q: 'The color of snow.', a: ['white'], lv: 'A1' },
    { l: 'W', q: 'A woman (adult female).', a: ['woman'], lv: 'A1' },
    { l: 'W', q: 'To perform a task for money.', a: ['work'], lv: 'A1' },

    // Y Harfi
    { l: 'Y', q: 'The color of a lemon.', a: ['yellow'], lv: 'A1' },
    { l: 'Y', q: 'A period of 365 days.', a: ['year'], lv: 'A1' },
    { l: 'Y', q: 'The opposite of no.', a: ['yes'], lv: 'A1' },
    { l: 'Y', q: 'The day before today.', a: ['yesterday'], lv: 'A1' },
    { l: 'Y', q: 'The opposite of old (person).', a: ['young'], lv: 'A1' },
    { l: 'Y', q: 'The color of the center of an egg.', a: ['yolk'], lv: 'A1' },
    { l: 'Y', q: 'A creamy milk product.', a: ['yogurt', 'yoghurt'], lv: 'A1' },
    { l: 'Y', q: 'Referring to the person being spoken to.', a: ['you'], lv: 'A1' },

    // Z Harfi
    { l: 'Z', q: 'A park for wild animals.', a: ['zoo'], lv: 'A1' },
    { l: 'Z', q: 'The number before one.', a: ['zero'], lv: 'A1' },
    { l: 'Z', q: 'A striped black and white animal.', a: ['zebra'], lv: 'A1' },
    { l: 'Z', q: 'A tool to close a jacket.', a: ['zip', 'zipper'], lv: 'A1' },
    { l: 'Z', q: 'To move very quickly.', a: ['zoom'], lv: 'A1' },
    { l: 'Z', q: 'A specific area.', a: ['zone'], lv: 'A1' },
...
const a2Words = [ 
  const a2Words = [
    ...
    { l: 'A', q: 'The part of a story that is exciting or happening.', a: ['action'], lv: 'A2' },
    { l: 'A', q: 'To give someone a suggestion about what to do.', a: ['advise'], lv: 'A2' },
    { l: 'A', q: 'In fact; used to correct a mistake.', a: ['actually'], lv: 'A2' },
    ...
    { l: 'B', q: 'Having a sharp, strong taste (like black coffee).', a: ['bitter'], lv: 'A2' },
    { l: 'B', q: 'To heat liquid until it bubbles.', a: ['boil'], lv: 'A2' },
    { l: 'B', q: 'Not interesting or exciting.', a: ['boring'], lv: 'A2' },

    // C Harfi
    { l: 'C', q: 'A place where you watch films (UK/US).', a: ['cinema', 'movie theater'], lv: 'A2' },
    { l: 'C', q: 'To pick something from a group.', a: ['choose'], lv: 'A2' },
    { l: 'C', q: 'A person who buys goods or services.', a: ['customer'], lv: 'A2' },
    { l: 'C', q: 'The way the air feels (hot, cold, rainy).', a: ['climate'], lv: 'A2' },
    ...
    { l: 'D', q: 'The meal you eat in the evening.', a: ['dinner'], lv: 'A2' },
    { l: 'D', q: 'Not wet.', a: ['dry'], lv: 'A2' },
    ...
    { l: 'E', q: 'Something that is usual or common.', a: ['everyday'], lv: 'E2' },
    { l: 'E', q: 'A large gray animal with a long nose.', a: ['elephant'], lv: 'A2' },
    { l: 'E', q: 'To leave a place or a building.', a: ['exit'], lv: 'A2' },
    { l: 'E', q: 'A test of knowledge or skill.', a: ['exam', 'examination'], lv: 'A2' },
    { l: 'E', q: 'To make something clear to someone.', a: ['explain'], lv: 'A2' },
    { l: 'E', q: 'The cost of something.', a: ['expensive'], lv: 'A2' },
    ...
    { l: 'F', q: 'To complete a form or a task.', a: ['finish'], lv: 'A2' },
    { l: 'F', q: 'To fail to remember.', a: ['forget'], lv: 'A2' },
    { l: 'F', q: 'To be scared of something.', a: ['frightened', 'fear'], lv: 'A2' },
    { l: 'F', q: 'A person who comes from another country.', a: ['foreigner'], lv: 'A2' },
    { l: 'F', q: 'At a great distance in space or time.', a: ['far'], lv: 'A2' },
    ...
    { l: 'G', q: 'A small gift or something given.', a: ['gift'], lv: 'A2' },
    { l: 'G', q: 'To understand or receive.', a: ['get'], lv: 'A2' },
    { l: 'G', q: 'A person whose job is to guide tourists.', a: ['guide'], lv: 'A2' },
    { l: 'G', q: 'To provide a reason or an answer.', a: ['give'], lv: 'A2' },
    { l: 'G', q: 'To be happy or pleased.', a: ['glad'], lv: 'A2' },
    { l: 'G', q: 'A building where cars are kept.', a: ['garage'], lv: 'A2' },

    // H Harfi
    { l: 'H', q: 'A building for sick people.', a: ['hospital'], lv: 'A2' },
    { l: 'H', q: 'Something you do in your free time.', a: ['hobby'], lv: 'A2' },
    { l: 'H', q: 'A period of time away from work or school.', a: ['holiday', 'vacation'], lv: 'A2' },
    { l: 'H', q: 'To think something will happen.', a: ['hope'], lv: 'A2' },
    { l: 'H', q: 'The state of your body and mind.', a: ['health'], lv: 'A2' },
    { l: 'H', q: 'Something that is not easy.', a: ['hard'], lv: 'A2' },
    { l: 'H', q: 'To happen or take place.', a: ['happen'], lv: 'A2' },
    { l: 'H', q: 'To find something that was lost.', a: ['help'], lv: 'A2' },

    // I Harfi
    { l: 'I', q: 'Something that is not possible.', a: ['impossible'], lv: 'A2' },
    ...
    { l: 'I', q: 'To be very interested in something.', a: ['interested'], lv: 'A2' },
    { l: 'I', q: 'A person who creates something new.', a: ['inventor'], lv: 'A2' },
    { l: 'I', q: 'A tool for making things.', a: ['instrument'], lv: 'A2' },
    { l: 'I', q: 'Facts about a situation or person.', a: ['information'], lv: 'A2' },

    // J Harfi
    { l: 'J', q: 'A funny story to make people laugh.', a: ['joke'], lv: 'A2' },
    { l: 'J', q: 'Going from one place to another.', a: ['journey'], lv: 'A2' },
    { l: 'J', q: 'To become a member of a group.', a: ['join'], lv: 'A2' },
    { l: 'J', q: 'A drink made from fruit.', a: ['juice'], lv: 'A2' },
    { l: 'J', q: 'The month before August.', a: ['july'], lv: 'A2' },
    { l: 'J', q: 'To move off the ground using legs.', a: ['jump'], lv: 'A2' },
    { l: 'J', q: 'A piece of clothing for the upper body.', a: ['jacket'], lv: 'A2' },
    { l: 'J', q: 'The month that starts the year.', a: ['january'], lv: 'A2' },

    // K Harfi
    { l: 'K', q: 'The part of your body where the leg bends.', a: ['knee'], lv: 'A2' },
    { l: 'K', q: 'To touch with lips.', a: ['kiss'], lv: 'A2' },
    { l: 'K', q: 'To be friendly and helpful.', a: ['kind'], lv: 'A2' },
    { l: 'K', q: 'A person who rules a country.', a: ['king'], lv: 'A2' },
    { l: 'K', q: 'To have information about something.', a: ['know'], lv: 'A2' },
    { l: 'K', q: 'A tool for opening locks.', a: ['key'], lv: 'A2' },
    { l: 'K', q: 'To strike with the foot.', a: ['kick'], lv: 'A2' },
    { l: 'K', q: 'The room used for cooking.', a: ['kitchen'], lv: 'A2' },

    // L Harfi
    { l: 'L', q: 'Something that is not heavy.', a: ['light'], lv: 'A2' },
    { l: 'L', q: 'To smile and make sounds because of a joke.', a: ['laugh'], lv: 'A2' },
    { l: 'L', q: 'A person who leads a group.', a: ['leader'], lv: 'A2' },
    { l: 'L', q: 'A story that people tell (often old).', a: ['legend'], lv: 'A2' },
    { l: 'L', q: 'To get knowledge by studying.', a: ['learn'], lv: 'A2' },
    { l: 'L', q: 'A part of the body for walking.', a: ['leg'], lv: 'A2' },
    { l: 'L', q: 'To pay attention to a sound.', a: ['listen'], lv: 'A2' },
    { l: 'L', q: 'The opposite of win.', a: ['lose'], lv: 'A2' },

    // M Harfi
    { l: 'M', q: 'To fix something that is broken (UK/US).', a: ['mend', 'fix'], lv: 'A2' },
    { l: 'M', q: 'A large building for old objects.', a: ['museum'], lv: 'A2' },
    { l: 'M', q: 'To have a meeting with someone.', a: ['meet'], lv: 'A2' },
    { l: 'M', q: 'A person whose job is to fix cars.', a: ['mechanic'], lv: 'A2' },
    { l: 'M', q: 'A story shown on a screen.', a: ['movie', 'film'], lv: 'A2' },
    { l: 'M', q: 'A large hill.', a: ['mountain'], lv: 'A2' },
    { l: 'M', q: 'The object that shines in the night sky.', a: ['moon'], lv: 'A2' },
    { l: 'M', q: 'To move from one place to another.', a: ['move'], lv: 'A2' },

    // N Harfi
    { l: 'N', q: 'A person who lives next door (UK/US).', a: ['neighbor', 'neighbour'], lv: 'A2' },
    { l: 'N', q: 'The opposite of always.', a: ['never'], lv: 'A2' },
    { l: 'N', q: 'The part of the body between the head and body.', a: ['neck'], lv: 'A2' },
    ...
    { l: 'N', q: 'The opposite of noisy.', a: ['nice', 'normal'], lv: 'A2' },
    { l: 'N', q: 'To be worried or slightly afraid.', a: ['nervous'], lv: 'A2' },

    // O Harfi
    { l: 'O', q: 'The opposite of under.', a: ['over'], lv: 'A2' },
    { l: 'O', q: 'To happen or take place (More formal).', a: ['occur'], lv: 'A2' },
    ...
    { l: 'O', q: 'Opposite of inside.', a: ['outside'], lv: 'A2' },
    { l: 'O', q: 'A fruit and a color.', a: ['orange'], lv: 'A2' },
    ...
    { l: 'P', q: 'To engage in a game or sport.', a: ['play'], lv: 'A2' },
    { l: 'P', q: 'Something you use to write.', a: ['pencil', 'pen'], lv: 'A2' },
    { l: 'P', q: 'A place where you can catch a train.', a: ['platform'], lv: 'A2' },
    { l: 'P', q: 'A person who writes poems.', a: ['poet'], lv: 'A2' },
    { l: 'P', q: 'A prize for winning.', a: ['prize'], lv: 'A2' },

    // Q Harfi
    { l: 'Q', q: 'To answer this.', a: ['question'], lv: 'A2' },
    { l: 'Q', q: 'Not loud.', a: ['quiet'], lv: 'A2' },
    { l: 'Q', q: 'To stop doing something.', a: ['quit'], lv: 'A2' },
    { l: 'Q', q: 'A short test of knowledge.', a: ['quiz'], lv: 'A2' },
    { l: 'Q', q: 'Completely or very.', a: ['quite'], lv: 'A2' },
    { l: 'Q', q: 'A woman who rules.', a: ['queen'], lv: 'A2' },
    { l: 'Q', q: 'A line of people waiting (UK).', a: ['queue'], lv: 'A2' },
    { l: 'Q', q: 'Doing something in a short time.', a: ['quick'], lv: 'A2' },

    // R Harfi
    { l: 'R', q: 'To go back to a place.', a: ['return'], lv: 'A2' },
    { l: 'R', q: 'A person whose job is to report news.', a: ['reporter'], lv: 'A2' },
    { l: 'R', q: 'To remember something.', a: ['recall'], lv: 'A2' },
    { l: 'R', q: 'The opposite of wrong.', a: ['right'], lv: 'A2' },
    { l: 'R', q: 'To move fast on legs.', a: ['run'], lv: 'A2' },
    { l: 'R', q: 'A place where you eat.', a: ['restaurant'], lv: 'A2' },
    { l: 'R', q: 'To look at words.', a: ['read'], lv: 'A2' },
    { l: 'R', q: 'A large flow of water.', a: ['river'], lv: 'A2' },

    // S Harfi
    { l: 'S', q: 'Not loud.', a: ['soft', 'silent'], lv: 'A2' },
    { l: 'S', q: 'A large body of salt water.', a: ['sea'], lv: 'A2' },
    { l: 'S', q: 'A person whose job is to help in a shop.', a: ['seller', 'salesman'], lv: 'A2' },
    { l: 'S', q: 'To stay in the same place.', a: ['stay'], lv: 'A2' },
    { l: 'S', q: 'To learn at school.', a: ['study'], lv: 'A2' },
    { l: 'S', q: 'Something that is not difficult.', a: ['simple'], lv: 'A2' },
    { l: 'S', q: 'A time of year (Spring, Summer...).', a: ['season'], lv: 'A2' },
    { l: 'S', q: 'To be certain about something.', a: ['sure'], lv: 'A2' },

    // T Harfi
    { l: 'T', q: 'A long distance call device.', a: ['telephone', 'phone'], lv: 'A2' },
    { l: 'T', q: 'A person who helps people learn.', a: ['teacher'], lv: 'A2' },
    { l: 'T', q: 'A vehicle that flies.', a: ['transport', 'taxi'], lv: 'A2' },
    { l: 'T', q: 'To speak with someone.', a: ['talk'], lv: 'A2' },
    { l: 'T', q: 'To go from one place to another.', a: ['travel'], lv: 'A2' },
    { l: 'T', q: 'A very large plant.', a: ['tree'], lv: 'A2' },
    { l: 'T', q: 'The meal between breakfast and dinner.', a: ['tea', 'tiffin'], lv: 'A2' },
    ...
    { l: 'U', q: 'A person who uses something.', a: ['user'], lv: 'A2' },
    { l: 'U', q: 'Used for rain.', a: ['umbrella'], lv: 'A2' },
    ...
    { l: 'V', q: 'A holiday.', a: ['vacation'], lv: 'A2' },

    // W Harfi
    { l: 'W', q: 'Something you wear on your wrist to tell time.', a: ['watch'], lv: 'A2' },
    { l: 'W', q: 'To move slowly on feet.', a: ['walk'], lv: 'A2' },
    { l: 'W', q: 'To be worried or concerned.', a: ['worry'], lv: 'A2' },
    { l: 'W', q: 'The opposite of strong.', a: ['weak'], lv: 'A2' },
    { l: 'W', q: 'To get a prize in a game.', a: ['win'], lv: 'A2' },
    { l: 'W', q: 'The season after autumn.', a: ['winter'], lv: 'A2' },
    { l: 'W', q: 'To perform a task.', a: ['work'], lv: 'A2' },
    { l: 'W', q: 'Liquid needed for life.', a: ['water'], lv: 'A2' },

    // Y Harfi
    { l: 'Y', q: 'Twelve months.', a: ['year'], lv: 'A2' },
    { l: 'Y', q: 'The opposite of old (person).', a: ['young'], lv: 'A2' },
    { l: 'Y', q: 'The opposite of no.', a: ['yes'], lv: 'A2' },
    { l: 'Y', q: 'The color of a lemon.', a: ['yellow'], lv: 'A2' },
    { l: 'Y', q: 'The day before today.', a: ['yesterday'], lv: 'A2' },
    { l: 'Y', q: 'A creamy milk food.', a: ['yogurt', 'yoghurt'], lv: 'A2' },
    { l: 'Y', q: 'A long piece of thread.', a: ['yarn'], lv: 'A2' },
    { l: 'Y', q: 'To shout loudly.', a: ['yell'], lv: 'A2' },

    // Z Harfi
    { l: 'Z', q: 'Nothing (score in sports).', a: ['zero', 'love'], lv: 'A2' },
    { l: 'Z', q: 'A striped animal.', a: ['zebra'], lv: 'A2' },
    { l: 'Z', q: 'A place for animals.', a: ['zoo'], lv: 'A2' },
    { l: 'Z', q: 'To move very fast.', a: ['zoom'], lv: 'A2' },
    { l: 'Z', q: 'A tool for closing clothes.', a: ['zip', 'zipper'], lv: 'A2' },
...
const b1Words = [ 
  const b1Words = [
    ...
    { l: 'B', q: 'A person whose job is to kill and sell meat.', a: ['butcher'], lv: 'B1' },
    { l: 'B', q: 'Underneath or at a lower level.', a: ['beneath'], lv: 'B1' },
    { l: 'B', q: 'To puzzle or confuse someone.', a: ['bewilder'], lv: 'B1' },
    { l: 'B', q: 'A short statement of the main points.', a: ['brief'], lv: 'B1' },

    // C Harfi
    { l: 'C', q: 'The appearance or hue of something (UK/US).', a: ['color', 'colour'], lv: 'B1' },
    ...
    { l: 'C', q: 'The state of the atmosphere at a place.', a: ['climate'], lv: 'B1' },
    ...
    { l: 'D', q: 'To stop something from happening for a while.', a: ['delay'], lv: 'B1' },
    { l: 'D', q: 'A small part or item of something.', a: ['detail'], lv: 'B1' },
    { l: 'D', q: 'A person who fixes teeth (Common but Professional).', a: ['dentist'], lv: 'B1' },
    { l: 'D', q: 'A situation that is hard to deal with.', a: ['difficulty'], lv: 'B1' },
    ...
    { l: 'F', q: 'Known by many people.', a: ['famous'], lv: 'B1' },
    { l: 'F', q: 'To do with money or how it is managed.', a: ['financial'], lv: 'B1' },
    { l: 'F', q: 'A flat surface on which a picture is shown.', a: ['frame'], lv: 'B1' },
    ...
    // H Harfi
    { l: 'H', q: 'A place where ships can stay (UK/US).', a: ['harbor', 'harbour'], lv: 'B1' },
    { l: 'H', q: 'To be unsure or wait before acting.', a: ['hesitate'], lv: 'B1' },
    { l: 'H', q: 'Something that is very difficult.', a: ['hardship'], lv: 'B1' },
    { l: 'H', q: 'The distance from the bottom to the top.', a: ['height'], lv: 'B1' },
    { l: 'H', q: 'A person who is brave.', a: ['hero'], lv: 'B1' },
    { l: 'H', q: 'To think about something in a way that gives pleasure.', a: ['honor', 'honour'], lv: 'B1' },
    { l: 'H', q: 'To keep something away from others.', a: ['hide'], lv: 'B1' },
    { l: 'H', q: 'Extremely large.', a: ['huge'], lv: 'B1' },

    // I Harfi
    { l: 'I', q: 'To make something better.', a: ['improve'], lv: 'B1' },
    { l: 'I', q: 'To tell someone they should do something.', a: ['instruct'], lv: 'B1' },
    { l: 'I', q: 'A person who writes for a newspaper.', a: ['journalist'], lv: 'B1' }, // J letter context, moved below
    ...
    { l: 'J', q: 'The month before August.', a: ['july'], lv: 'B1' },

    // K Harfi
    { l: 'K', q: 'To continue to have or hold something.', a: ['keep'], lv: 'B1' },
    { l: 'K', q: 'A person who is famous for their skill.', a: ['knight'], lv: 'B1' },
    { l: 'K', q: 'The act of being friendly and helpful.', a: ['kindness'], lv: 'B1' },
    { l: 'K', q: 'A small house for a dog.', a: ['kennel'], lv: 'B1' },
    { l: 'K', q: 'To set something on fire.', a: ['kindle'], lv: 'B1' },
    { l: 'K', q: 'A person who is related to you.', a: ['kin'], lv: 'B1' },
    { l: 'K', q: 'A small piece of wood.', a: ['kindling'], lv: 'B1' },
    { l: 'K', q: 'The understanding of a subject.', a: ['knowledge'], lv: 'B1' },

    // L Harfi
    { l: 'L', q: 'A place for scientific experiments.', a: ['laboratory', 'lab'], lv: 'B1' },
    { l: 'L', q: 'A person who owns a building (UK/US).', a: ['landlord'], lv: 'B1' },
    ...
    { l: 'L', q: 'A person who lives a long time.', a: ['lifer'], lv: 'B1' },
    { l: 'L', q: 'Something that is likely to happen.', a: ['likely'], lv: 'B1' },
    { l: 'L', q: 'To be in a specific position.', a: ['locate'], lv: 'B1' },

    // M Harfi
    { l: 'M', q: 'A person whose job is to dig for coal.', a: ['miner'], lv: 'B1' },
    { l: 'M', q: 'A person who handles money or a business.', a: ['manager'], lv: 'B1' },
    { l: 'M', q: 'Something that is very impressive.', a: ['magnificent'], lv: 'B1' },
    { l: 'M', q: 'To stay in the same state.', a: ['maintain'], lv: 'B1' },
    { l: 'M', q: 'A person who is the head of a city.', a: ['mayor'], lv: 'B1' },
    { l: 'M', q: 'To have a specific meaning.', a: ['mean'], lv: 'B1' },
    { l: 'M', q: 'A way of doing something.', a: ['method'], lv: 'B1' },
    { l: 'M', q: 'To keep something in your mind.', a: ['memory'], lv: 'B1' },

    // N Harfi
    { l: 'N', q: 'To not take sides in an argument.', a: ['neutral'], lv: 'B1' },
    { l: 'N', q: 'A person who lives next door.', a: ['neighbor', 'neighbour'], lv: 'B1' },
    { l: 'N', q: 'To notice something.', a: ['note'], lv: 'B1' },
    { l: 'N', q: 'Something that is very common or usual.', a: ['normal'], lv: 'B1' },
    { l: 'N', q: 'A long story in a book.', a: ['novel'], lv: 'B1' },
    { l: 'N', q: 'A person who is trained to care for sick people.', a: ['nurse'], lv: 'B1' },
    { l: 'N', q: 'At no time.', a: ['never'], lv: 'B1' },
    { l: 'N', q: 'To be slightly afraid.', a: ['nervous'], lv: 'B1' },

    // O Harfi
    { l: 'O', q: 'To happen or take place.', a: ['occur'], lv: 'B1' },
    { l: 'O', q: 'To suggest a plan or idea.', a: ['offer'], lv: 'B1' },
    { l: 'O', q: 'To be in charge of a place.', a: ['occupy'], lv: 'B1' },
    { l: 'O', q: 'To provide a point of view.', a: ['opinion'], lv: 'B1' },
    { l: 'O', q: 'To go against something.', a: ['oppose'], lv: 'B1' },
    { l: 'O', q: 'A chance to do something.', a: ['opportunity'], lv: 'B1' },
    { l: 'O', q: 'Something that is typical or normal.', a: ['ordinary'], lv: 'B1' },
    ...
    { l: 'P', q: 'To say that something will happen in the future.', a: ['predict'], lv: 'B1' },
    { l: 'P', q: 'To achieve something.', a: ['perform'], lv: 'B1' },
    { l: 'P', q: 'To persuade someone to do something.', a: ['prompt'], lv: 'B1' },
    { l: 'P', q: 'To provide a reason.', a: ['purpose'], lv: 'B1' },
    { l: 'P', q: 'A person whose job is to represent a country.', a: ['politician'], lv: 'B1' },

    // Q Harfi
    { l: 'Q', q: 'The standard of something.', a: ['quality'], lv: 'B1' },
    { l: 'Q', q: 'A certain amount of something.', a: ['quantity'], lv: 'B1' },
    { l: 'Q', q: 'To have the right skills for a job.', a: ['qualify'], lv: 'B1' },
    { l: 'Q', q: 'To speak or repeat the words of another.', a: ['quote'], lv: 'B1' },
    { l: 'Q', q: 'To stop a job or activity.', a: ['quit'], lv: 'B1' },
    { l: 'Q', q: 'To be silent or calm.', a: ['quiet'], lv: 'B1' },
    { l: 'Q', q: 'A short test.', a: ['quiz'], lv: 'B1' },
    { l: 'Q', q: 'A question or doubt.', a: ['query'], lv: 'B1' },

    // R Harfi
    { l: 'R', q: 'To accept something as true.', a: ['recognize', 'recognise'], lv: 'B1' },
    { l: 'R', q: 'To make something smaller.', a: ['reduce'], lv: 'B1' },
    { l: 'R', q: 'To speak about someone or something.', a: ['refer'], lv: 'B1' },
    ...
    // S Harfi
    { l: 'S', q: 'A person who works for another.', a: ['servant'], lv: 'B1' },
    { l: 'S', q: 'To choose something.', a: ['select'], lv: 'B1' },
    { l: 'S', q: 'A plan or method to achieve a goal.', a: ['strategy'], lv: 'B1' },
    ...
    // T Harfi
    { l: 'T', q: 'A large road vehicle (UK/US).', a: ['truck', 'lorry'], lv: 'B1' },
    { l: 'T', q: 'To aim at a goal.', a: ['target'], lv: 'B1' },
    { l: 'T', q: 'To think about a specific subject.', a: ['topic'], lv: 'B1' },
    ...
    { l: 'T', q: 'To send something from one place to another.', a: ['transmit'], lv: 'B1' },
    { l: 'T', q: 'A typical quality or feature.', a: ['trait'], lv: 'B1' },
    { l: 'T', q: 'A small amount of something.', a: ['trace'], lv: 'B1' },

    // U Harfi
    { l: 'U', q: 'To think that something is true.', a: ['understand'], lv: 'B1' },
    { l: 'U', q: 'To make something better or more modern.', a: ['upgrade'], lv: 'B1' },
    { l: 'U', q: 'To stress the importance of something.', a: ['underline'], lv: 'B1' },
    { l: 'U', q: 'To agree to do a task.', a: ['undertake'], lv: 'B1' },
    { l: 'U', q: 'To support or hold up.', a: ['uphold'], lv: 'B1' },
    { l: 'U', q: 'The city area.', a: ['urban'], lv: 'B1' },
    { l: 'U', q: 'Something that is necessary.', a: ['urgent'], lv: 'B1' },
    { l: 'U', q: 'To use something.', a: ['utilize', 'utilise'], lv: 'B1' },

    // V Harfi
    { l: 'V', q: 'Someone who offers to do work for no pay.', a: ['volunteer'], lv: 'B1' },
    { l: 'V', q: 'Something that is empty or not occupied.', a: ['vacant'], lv: 'B1' },
    { l: 'V', q: 'To check if something is true.', a: ['verify'], lv: 'B1' },
    { l: 'V', q: 'A person who has been hurt or killed.', a: ['victim'], lv: 'B1' },
    ...
    { l: 'V', q: 'A journey by sea.', a: ['voyage'], lv: 'B1' },

    // W Harfi
    { l: 'W', q: 'A person who sees a crime happen.', a: ['witness'], lv: 'B1' },
    { l: 'W', q: 'Something that is worth a lot of money.', a: ['wealthy'], lv: 'B1' },
    { l: 'W', q: 'A weapon or tool for fighting.', a: ['weapon'], lv: 'B1' },
    { l: 'W', q: 'To be concerned about something.', a: ['worry'], lv: 'B1' },
    { l: 'W', q: 'A person who is smart or clever.', a: ['wise'], lv: 'B1' },
    { l: 'W', q: 'To move back and forth.', a: ['wave'], lv: 'B1' },
    { l: 'W', q: 'The state of the air (rainy, sunny).', a: ['weather'], lv: 'B1' },
    { l: 'W', q: 'To be prepared for something.', a: ['willing'], lv: 'B1' },

    // Y Harfi
    { l: 'Y', q: 'Part of an egg.', a: ['yolk'], lv: 'B1' },
    { l: 'Y', q: 'A measurement of length (3 feet).', a: ['yard'], lv: 'B1' },
    { l: 'Y', q: 'To produce or provide a result.', a: ['yield'], lv: 'B1' },
    { l: 'Y', q: 'To shout loudly.', a: ['yell'], lv: 'B1' },
    { l: 'Y', q: 'A period of 365 days.', a: ['year'], lv: 'B1' },
    { l: 'Y', q: 'Referring to young people.', a: ['youth'], lv: 'B1' },
    ...
    { l: 'Z', q: 'To move quickly or focus on.', a: ['zoom'], lv: 'B1' },
    { l: 'Z', q: 'A specific region or area.', a: ['zone'], lv: 'B1' },
    { l: 'Z', q: 'The highest point.', a: ['zenith'], lv: 'B1' },
    { l: 'Z', q: 'A striped animal.', a: ['zebra'], lv: 'B1' },
    { l: 'Z', q: 'Nothing or a low point.', a: ['zero'], lv: 'B1' },
